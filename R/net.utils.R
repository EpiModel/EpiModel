...
#' check_bip_degdist(num.m1 = 500, num.g2 = 500,
...
#'
check_bip_degdist <- function(num.m1, num.g2,
                              deg.dist.m1, deg.dist.g2) {
  ...
  mat <- rbind(mat, c(sum(deg.dist.m1), tot.deg.m1, sum(deg.dist.g2), tot.deg.g2))
  colnames(mat) <- c("m1.dist", "m1.cnt", .g2.dist", .g2.cnt")
  rownames(mat) <- c(paste0("Deg", 0:(length(deg.dist.m1) - 1)), "Edges")
  cat("Bipartite Degree Distribution Check\n")
  cat("=============================================\n")
  print(mat, print.gap = 3)
  cat("=============================================\n")
  reldiff <- (tot.deg.m1 - tot.deg.g2) / tot.deg.g2
  absdiff <- abs(tot.deg.m1 - tot.deg.g2)
  ...
  invisible(c(tot.deg.m1, deg.counts.m1, deg.counts.g2))
}
