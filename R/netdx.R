...
#'        details).
#' @param sequential For static diagnostics (`dynamic=FALSE`): if `FALSE`,
...
#' @param keep.tnetwork If `TRUE`, keep the full networkDynamic objects from
...
#' @param skip.dissolution If `TRUE`, skip over the calculations of duration
...
#'
#' @seealso Plot these model diagnostics with `\link{plot.netdx}`.
#'
#' @export
#'
#' @examples
