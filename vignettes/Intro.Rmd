...
Advanced topics are covered in two vignettes: - Working With Model Parameters `r vignette("model-parameters")` - Working With Custom Attributes and Summary Statistics `r vignette("attributes-and-summary-statistics")`
