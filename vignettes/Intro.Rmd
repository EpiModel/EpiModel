...
2. After that, we suggest you work through the NME course materials to understand some of the background network theory and see how to run parameterize and run built-in network models (Day 1-4 materials).
3. Those interested in extending EpiModel for novel research aims should then consult the model extension materials of NME (Days 4-5), and look at the variety of extension model templates in our **EpiModel Gallery** (<https://github.com/EpiModel/EpiModel-Gallery>).
