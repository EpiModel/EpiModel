...
### Installation
The current version of EpiModel is 1.0. The software may be downloaded from [http://cran.r-project.org/web/packages/EpiModel/index.html CRAN], and from within R using:
```r
