...
**This update only applies to built-in models.**
...
As mentioned previously, this change was done in order to emphasize to the user that this is a non-standard model type that is not handled by base EpiModel and may lead to unexpected results. Instead, all of the disease (non-protected) modules must be specified.
