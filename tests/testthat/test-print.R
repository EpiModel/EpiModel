...
test_that("print.dcm", {
  ...
  expect_output(print(mod1), "EpiModel Object")
  expect_output(print(mod1), "Model class: dcm")
  expect_output(print(mod1), "Model type: SI")
  expect_output(print(mod1), "inf.prob = 0.2")
  expect_output(print(mod1), "act.rate = 0.25")
  expect_output(print(mod1), "Compartments: s.num i.num num")
  expect_output(print(mod1), "Flows: si.flow")
})
...
test_that("print.icm", {
  ...
  control <- control.icm(type = "SI", nsteps = 500, nsims = 5, verbose = FALSE)
  mod1 <- icm(param, init, control)
  expect_output(print(mod1), "EpiModel Object")
  expect_output(print(mod1), "Model class: icm")
  expect_output(print(mod1), "Model type: SI")
  expect_output(print(mod1), "inf.prob = 0.2")
  expect_output(print(mod1), "act.rate = 0.25")
  expect_output(print(mod1), "Compartments: s.num i.num num")
