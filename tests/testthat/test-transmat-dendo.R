...
test_that("as.phylo.transmat", {
  ...
  expect_equal(names(phy),
               c("edge", "Nnode", "tip.label", "node.label", "root.edge",
                 "edge.length"))
  # lazy test, this is just veryify that the output matches previous output.
  expect_equal(phy, structure(list(edge = structure(c(55, 55, 56, 56, 57, 57,
                                                      58, 58, 59, 59, 60, 60,
                                                      61, 61, 62, 62, 63, 63,
                                                      64, 64, 65, 65, 66, 66,
                                                      67, 67, 68, 68, 69, 69,
                                                   ...
                                                   .Dimnames =
                                                     list(NULL, c("",
                                                                 "infector"))),
                                  Nnode = 53L,
                                  tip.label = c(72L, 83L, 76L, 8L,  10L, 75L,
                                                36L, 66L, 17L, 78L, 92L, 70L,
                                                60L, 24L, 39L, 18L, 51L, 81L,
                                                49L, 21L, 14L, 62L, 38L, 44L,
                                                69L, 73L, 99L, 35L, 1L, 5L, 9L,
                                                97L, 87L, 98L, 82L, 15L, 90L,
                                                28L, 45L, 56L, 7L, 27L, 64L,
                                                46L, 68L, 42L, 79L, 63L, 86L,
                                                25L, 48L, 32L, 3L, 37L),
                                  node.label = c(72L,  72L, 72L, 83L, 83L, 83L,
                                                 76L, 8L, 8L, 10L, 10L, 10L,
                                                 75L, 8L,  36L, 10L, 36L, 66L,
                                                 17L, 78L, 36L, 92L, 83L, 70L,
                                                 60L, 24L, 39L,  70L, 18L, 70L,
                                                 51L, 81L, 51L, 18L, 36L, 36L,
                                                 81L, 8L, 49L, 21L,  14L, 8L,
                                                 62L, 17L, 38L, 44L, 69L, 73L,
                                                 69L, 99L, 35L, 18L, 1L),
                                  root.edge = 2L, edge.length = c(0, 4, 2, 22,
                                                                  37, 9, 4, 35,
                                                                  1, 1, 11, 30,
                                                                  30, 1, 0, 1,
                                                                  2, 24, 0, 1,
                                                                  ...
                                                                  2, 2, 1, 1, 1,
                                                                  1, 1, 1)),
                             .Names = c("edge", "Nnode", "tip.label",
                                        "node.label", "root.edge",
                                        "edge.length"),
                             class = "phylo"))
  ...
  expect_warning(as.phylo(tiny),
                 regexp = "input does not have appropriate column names")
  ...
  evo_tm <- structure(list(at = c(50L, 230L, 573L, 622L, 650L, 652L, 678L,
                                  852L, 914L, 1032L, 1083L, 1120L, 1134L, 1141L,
                                  1154L, 1252L, 1296L, 1320L, 1329L, 1349L,
                                  1351L, 1354L, 1385L, 1427L, 1451L,  1457L,
                                  1474L, 1518L, 1520L, 1521L, 1533L, 1534L,
                                  1540L, 1541L,  1551L, 1566L, 1572L, 1581L,
                                  1588L, 1603L, 1622L, 1624L, 1628L,  1650L,
                                  1651L, 1653L, 1653L, 1670L, 1687L, 1711L,
                                  1714L, 1723L,  1759L, 1800L, 1818L, 1821L),
                           sus = c(89, 66, 25, 22, 38, 58,  91, 18, 81, 40, 62,
                                   48, 111, 76, 80, 56, 53, 39, 94, 9, 102,
                                   11, 17, 33, 6, 12, 64, 10, 3, 82, 107, 108,
                                   68, 41, 26, 78, 109,  4, 114, 106, 42, 92,
                                   103, 30, 75, 112, 93, 7, 43, 24, 95, 60,
                                   110, 2, 55, 54),
                           inf = c(83, 83, 83, 25, 22, 22, 25, 83, 22,  22, 40,
                                   83, 62, 40, 111, 48, 66, 81, 53, 94, 62, 40,
                                   80, 25,  33, 48, 56, 18, 81, 81, 25, 56, 10,
                                   66, 39, 107, 10, 48, 48,  9, 62, 108, 40, 11,
                                   106, 94, 103, 108, 75, 25, 18, 9, 10, 82,
                                   83, 110)),
                      .Names = c("at", "sus", "inf"), row.names = c(NA,  -56L),
                      class = "transmat")
  evo_exit_times <- c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                      772,  NA, NA, NA, NA, NA, NA, 1169, NA, NA, NA, 1599, NA,
                      223, NA,  NA, 165, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                      NA, NA, NA,  NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                      NA, 1713, 1322, NA,  NA, NA, NA, NA, NA, NA, NA, NA, NA,
                      NA, NA, NA, NA, NA, NA, NA,  NA, NA, NA, NA, NA, NA, NA,
                      NA, 1090, NA, NA, NA, NA, 1651, NA,  NA, NA, NA, 1796, NA,
                      NA, NA, NA, NA, NA, NA, NA, 1727, NA, NA,  NA, NA, NA, NA,
                      NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,  NA, NA)

  evoPhylo <- as.phylo(evo_tm, vertex.exit.times = evo_exit_times)
  expect_equal(evoPhylo$edge.length, c(180, 1601, 343, 1066, 279, 49, 56, 28, 2,
                                       1173, 262, 670, 749,  1145, 268, 666,
                                       118, 406, 137, 51, 58, 51, 698, 132, 217,
                                       20,  213, 682, 669, 231, 205, 222, 245,
                                       33, 200, 231, 494, 20, 304,  254, 271,
                                       472, 274, 296, 438, 438, 106, 24, 372,
                                       372, 124, 366,  60, 349, 196, 22, 1, 303,
                                       302, 279, 178, 33, 289, 90, 32, 283,
                                       282, 282, 272, 48, 257, 257, 187, 251, 7,
                                       242, 235, 235, 120, 48, 201, 201, 46,
                                       199, 195, 25, 173, 173, 172, 36, 143,
                                       170, 74, 170, 153, 153, 136, 136, 112,
                                       112, 109, 109, 100, 100, 64, 62, 23, 23,
                                       5, 5, 2, 2))
  plot(evoPhylo, show.node.label = TRUE, cex = 0.6, root.edge = TRUE,
       tip.color = "blue")
  ...
  expect_message(two_phylo <- as.phylo.transmat(two_tree),
                 regexp = "found multiple trees")
