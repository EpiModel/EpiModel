...
init <- init.net(i.num = 10)
control <- control.net(type = "SIS", nsteps = 25, nsims = 1, ncores = 1, tgl = TRUE)
...
control <- control.net(type = "SIR", nsteps = 25, nsims = 1, ncores = 1, tgl = TRUE)
...
control <- control.net(type = "SI", nsteps = 20, nsims = 1, ncores = 1, tgl = TRUE)
...
control <- control.net(type = "SI", nsteps = 25, nsims = 1, ncores = 1, tgl = TRUE)
