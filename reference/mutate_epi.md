...
#> edges     50   50.267    0.533  2.114   0.126         7.616          7.08
#> 
#> 
#> Duration Statistics
#> ----------------------- 
#>       Target Sim Mean Pct Diff Sim SE Z Score SD(Sim Means) SD(Statistic)
#> edges     20   18.875   -5.623  0.418  -2.692         1.288         1.603
#> 
#> Dissolution Statistics
#> ----------------------- 
#>       Target Sim Mean Pct Diff Sim SE Z Score SD(Sim Means) SD(Statistic)
#> edges   0.05    0.051    1.451  0.002   0.327         0.003         0.027
#> 
...
#> 4    1    4    48     2  50       50        0     50       1          0   0.04
#> 5    1    5    48     2  50       50        0     50       0          0   0.04
#> 6    1    6    48     2  50       50        0     50       0          0   0.04
#> 7    1    7    48     2  50       50        0     50       0          0   0.04
#> 8    1    8    48     2  50       49        1     50       0          1   0.04
#> 9    1    9    48     2  50       49        1     50       0          0   0.04
#> 10   1   10    48     2  50       49        1     50       0          0   0.04
#> 11   2    1    49     1  50       50        0     50      NA         NA   0.02
#> 12   2    2    49     1  50       50        0     50       0          0   0.02
#> 13   2    3    49     1  50       50        0     50       0          0   0.02
#> 14   2    4    49     1  50       49        1     50       0          1   0.02
#> 15   2    5    48     2  50       49        1     50       1          0   0.04
#> 16   2    6    48     2  50       49        1     50       0          0   0.04
#> 17   2    7    48     2  50       49        1     50       0          0   0.04
#> 18   2    8    48     2  50       49        1     50       0          0   0.04
#> 19   2    9    48     2  50       49        1     50       0          0   0.04
#> 20   2   10    47     3  50       49        1     50       1          0   0.06
#> 21   3    1    49     1  50       50        0     50      NA         NA   0.02
#> 22   3    2    49     1  50       50        0     50       0          0   0.02
#> 23   3    3    49     1  50       49        1     50       0          1   0.02
#> 24   3    4    49     1  50       49        1     50       0          0   0.02
#> 25   3    5    49     1  50       49        1     50       0          0   0.02
#> 26   3    6    49     1  50       49        1     50       0          0   0.02
#> 27   3    7    49     1  50       48        2     50       0          1   0.02
#> 28   3    8    49     1  50       48        2     50       0          0   0.02
#> 29   3    9    49     1  50       47        3     50       0          1   0.02
#> 30   3   10    49     1  50       47        3     50       0          0   0.02
#>    i.prev.g2    ir100
#> 1       0.00       NA
#> 2       0.00  0.00000
#> 3       0.00  0.00000
...
#> 3     3 49.00000 1.000000  50 49.66667 0.3333333     50 0.0000000  0.3333333
#> 4     4 48.66667 1.333333  50 49.33333 0.6666667     50 0.3333333  0.3333333
#> 5     5 48.33333 1.666667  50 49.33333 0.6666667     50 0.3333333  0.0000000
#> 6     6 48.33333 1.666667  50 49.33333 0.6666667     50 0.0000000  0.0000000
#> 7     7 48.33333 1.666667  50 49.00000 1.0000000     50 0.0000000  0.3333333
#> 8     8 48.33333 1.666667  50 48.66667 1.3333333     50 0.0000000  0.3333333
#> 9     9 48.33333 1.666667  50 48.33333 1.6666667     50 0.0000000  0.3333333
#> 10   10 48.00000 2.000000  50 48.33333 1.6666667     50 0.3333333  0.0000000
#>        i.prev   i.prev.g2    ir100
#> 1  0.02000000 0.000000000      NaN
#> 2  0.02000000 0.000000000  0.00000
#> 3  0.02000000 0.006666667 17.68707
#> 4  0.02666667 0.013333333 35.37415
#> 5  0.03333333 0.013333333 17.86942
#> 6  0.03333333 0.013333333  0.00000
#> 7  0.03333333 0.020000000 17.86942
#> 8  0.03333333 0.026666667 17.86942
#> 9  0.03333333 0.033333333 18.05556
#> 10 0.04000000 0.033333333 18.05556
# }
```
